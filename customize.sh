...
if [ $? = 0 ];
	then
		sed -i '$a\\' lede/package/lean/default-settings/i18n/default.zh-cn.po
		sed -i '$amsgid\ "YSHX8\ Vendor"' lede/package/lean/default-settings/i18n/default.zh-cn.po
		sed -i '$amsgstr\ "制造商"' lede/package/lean/default-settings/i18n/default.zh-cn.po
		sed -i 's/<th class="cbi-section-table-cell"><%:MAC-Address%><\/th>/<th class="cbi-section-table-cell"><%:MAC-Address%><\/th>\n<th class="cbi-section-table-cell"><%:YSHX8\ Vendor%><\/th>/g' lede/package/lean/autocore/files/x86/index.htm
		sed -i 's/tr.insertCell(-1).innerHTML\ \=\ info.leases\[i\].macaddr;/tr.insertCell(-1).innerHTML\ \=\ info.leases\[i\].macaddr;\ntr.insertCell(-1).innerHTML\ \=\ \x27<a\ target\="_blank"\ href\="https:\/\/www.ipchecktool.com\/tool\/macfinder?oui=\x27\ +\ info.leases[i].macaddr\ +\ \x27">\x27\ +\ \x27line1<\/a>\ ,\ <a\ target\="_blank"\ href\="https:\/\/api.macvendors.com\/\x27\ +\ info.leases[i].macaddr\ +\ \x27">\x27\ +\ \x27line2<\/a>\x27;/g' lede/package/lean/autocore/files/x86/index.htm
	else
